...
@AuditLogAnnotation(value = "key_result接口")
@Slf4j
public class KeyResultController {
    ...
    @PutMapping("/review")
    @ApiOperation("更新key-result的review信息")
    public void updateObjectiveKeyResultReview(@RequestBody @Valid UpdateObjectiveKeyResulReviewDTO updateObjectiveKeyResulReviewDTO){
        keyResultService.updateObjectiveKeyResultReViewInfo(updateObjectiveKeyResulReviewDTO);
    }
